...
insert into superhero values(3, 'SteelFoot', 'MemoryEnhancer', 'blue', 1930);
...
values(2, 'DataMaster', 'SuperArmor', 'red', 1890);
...
insert into superhero values(6, 'Lightning', 'SearchEngine', 'helmet', 2000);